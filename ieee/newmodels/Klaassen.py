...
def Set_Mobility_Parameters(device, region):
    #As
    ds.set_parameter(device=device, region=region, name="mu_min_e",  value=52.2)
    ds.set_parameter(device=device, region=region, name="mu_max_e",  value=1417)
    ds.set_parameter(device=device, region=region, name="theta1_e",     value=2.285)
    ds.set_parameter(device=device, region=region, name="m_e",      value=1.0)
    ds.set_parameter(device=device, region=region, name="f_BH",     value=3.828)
    ds.set_parameter(device=device, region=region, name="f_CW",     value=2.459)
    ds.set_parameter(device=device, region=region, name="c_D",      value=0.21)
    ds.set_parameter(device=device, region=region, name="Nref_D",   value=4.0e20)
    ds.set_parameter(device=device, region=region, name="Nref_1_e", value=9.68e16)
    ds.set_parameter(device=device, region=region, name="alpha_1_e",    value=0.68)

    #B
    ds.set_parameter(device=device, region=region, name="mu_min_h",  value=44.9)
    ds.set_parameter(device=device, region=region, name="mu_max_h",  value=470.5)
    ds.set_parameter(device=device, region=region, name="theta1_h",     value=2.247)
    ds.set_parameter(device=device, region=region, name="m_h",      value=1.258)
    ds.set_parameter(device=device, region=region, name="c_A",      value=0.50)
    ds.set_parameter(device=device, region=region, name="Nref_A",   value=7.2e20)
    ds.set_parameter(device=device, region=region, name="Nref_1_h", value=2.2e17)
    ds.set_parameter(device=device, region=region, name="alpha_1_h",    value=0.719)


    #F_Pe F_Ph equations
    ds.set_parameter(device=device, region=region, name="r1", value=0.7643)
    ds.set_parameter(device=device, region=region, name="r2", value=2.2999)
    ds.set_parameter(device=device, region=region, name="r3", value=6.5502)
    ds.set_parameter(device=device, region=region, name="r4", value=2.3670)
    ds.set_parameter(device=device, region=region, name="r5", value=-0.01552)
    ds.set_parameter(device=device, region=region, name="r6", value=0.6478)

    #G_Pe G_Ph equations
    ds.set_parameter(device=device, region=region, name="s1", value=0.892333)
    ds.set_parameter(device=device, region=region, name="s2", value=0.41372)
    ds.set_parameter(device=device, region=region, name="s3", value=0.19778)
    ds.set_parameter(device=device, region=region, name="s4", value=0.28227)
    ds.set_parameter(device=device, region=region, name="s5", value=0.005978)
    ds.set_parameter(device=device, region=region, name="s6", value=1.80618)
    ds.set_parameter(device=device, region=region, name="s7", value=0.72169)

    # velocity saturation
    ds.set_parameter(device=device, region=region, name="vsat_e", value=1.0e7)
    ds.set_parameter(device=device, region=region, name="vsat_h", value=1.0e7)

    #Lucent Mobility
    ds.set_parameter(device=device, region=region, name="alpha_e", value=6.85e-21)
    ds.set_parameter(device=device, region=region, name="alpha_h", value=7.82e-21)
    ds.set_parameter(device=device, region=region, name="A_e", value=2.58)
    ds.set_parameter(device=device, region=region, name="A_h", value=2.18)
    ds.set_parameter(device=device, region=region, name="B_e", value=3.61e7)
    ds.set_parameter(device=device, region=region, name="B_h", value=1.51e7)
    ds.set_parameter(device=device, region=region, name="C_e", value=1.70e4)
    ds.set_parameter(device=device, region=region, name="C_h", value=4.18e3)
    ds.set_parameter(device=device, region=region, name="kappa_e", value=1.7)
    ds.set_parameter(device=device, region=region, name="kappa_h", value=0.9)
    ds.set_parameter(device=device, region=region, name="tau_e", value=0.0233)
    ds.set_parameter(device=device, region=region, name="tau_h", value=0.0119)
    ds.set_parameter(device=device, region=region, name="eta_e", value=0.0767)
    ds.set_parameter(device=device, region=region, name="eta_h", value=0.123)
    ds.set_parameter(device=device, region=region, name="delta_e", value=3.58e18)
    ds.set_parameter(device=device, region=region, name="delta_h", value=4.10e15)
